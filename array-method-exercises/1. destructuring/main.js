...
function printCharacterDetails() {
  ...
  console.log(character.species , character.occupation); // Expected Output: Human Jedi Knight
}
...
function printMissionDetails() {
  ...
  console.log(mission.planet, mission.year); // Expected Output: Jupiter 1979
}
